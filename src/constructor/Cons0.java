...
constructor is used to initialize non static members of the class
	type:
		1. default constructor -- when a class doesn't have any type of constructor dn java compiler write a constructor which known 
		as default constructor default constructor doesn't have any parameter and its body will be empty.
